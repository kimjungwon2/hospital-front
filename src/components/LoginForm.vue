    ...
    <div class="login_container">
        ...
        <form @submit.prevent="submitForm">
            ...
            <div class="oauth_login">
                <a href="http://kyeongihos.shop/api/oauth2/authorize/google?redirect_uri=http://kyeongihos.shop/oauth2/redirect">
                    <img class="login__google" width="65"  src="@/assets/google_logo.png" />
                </a>
                <a href="http://kyeongihos.shop/api/oauth2/authorize/naver?redirect_uri=http://kyeongihos.shop/oauth2/redirect">
                  <img class="login__naver" width="65" src="@/assets/naver_logo.png" />
                </a>
                <a href="http://kyeongihos.shop/api/oauth2/authorize/kakao?redirect_uri=http://kyeongihos.shop/oauth2/redirect">
